...
import { LocalizaIcon, CatadorPhoto} from '../../src/assets';
...
const ChartScreen = () => {
  ...
  return (
    ...
    <Text style={styles.TituloText}>Progresso</Text>
        ...
        <View style={styles.rightContainer}>
          <View style={styles.profileContainer}>
            <View style={styles.profileTextContainer}>
              ...
              <Text style={styles.profileText}>COLETA</Text>
            </View>
      ...
      <Text style={styles.title}>Quantidade de resíduos vendidos</Text>
      {renderCategoryTotal()}
      ...
      <View style={styles.lineChartContainer}>
        <Text style={styles.titleSegundoGrafico}>Quantidade de resíduos {'\n'} vendidos recria</Text>
        <LineChart
